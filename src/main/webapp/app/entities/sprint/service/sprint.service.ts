...
export class SprintService {
  ...
  createSprintPhase(risk: NewSprint, phaseId: number): Observable<EntityResponseType> {
    return this.http.post<ISprint>(`${this.resourceUrl}/phase/${phaseId}`, risk, { observe: 'response' });
  }
  ...
  getSprintTasks(id: number): Observable<HttpResponse<ITask[]>> {
    return this.http.get<ITask[]>(`${this.resourceUrl}/${id}/tasks`, { observe: 'response' });
  }
