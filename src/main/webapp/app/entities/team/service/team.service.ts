...
export class TeamService {
  ...
  createTeamProject(team: CreateTeam, projectId: number): Observable<EntityResponseType> {
    return this.http.post<IPhase>(`${this.resourceUrl}/project/${projectId}`, team, { observe: 'response' });
  }
  ...
  findTeamPeople(teamId: number): Observable<HttpResponse<IPersonUserRole[]>> {
    return this.http.get<IPersonUserRole[]>(`${this.resourceUrl}/${teamId}/people`, { observe: 'response' });
  }
