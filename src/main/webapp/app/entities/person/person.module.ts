...
import { ListCompanyPeopleComponent } from './list-company-people/list-company-people.component';

@NgModule({
  imports: [SharedModule, PersonRoutingModule],
  declarations: [PersonComponent, PersonDetailComponent, PersonUpdateComponent, PersonDeleteDialogComponent, ListCompanyPeopleComponent],
})
