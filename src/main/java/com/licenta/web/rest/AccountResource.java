...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        User user = userService.registerUser(
            ...
            managedUserVM.getSalary(),
            managedUserVM.getStatus(),
            managedUserVM.getHireDate(),
            managedUserVM.getDateOfBirth(),
            managedUserVM.getStreetAddress(),
            managedUserVM.getPostalCode(),
            managedUserVM.getCity(),
            managedUserVM.getRegion(),
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public void registerEmployee(@Valid @RequestBody EmployeeCreateDTO employeeCreateDTO, @PathVariable Long id) {
        if (isPasswordLengthInvalid(employeeCreateDTO.getPassword())) {
            throw new InvalidPasswordException();
        }
        User user = userService.registerEmployee(employeeCreateDTO, id);
        //        mailService.sendActivationEmail(user);
    }
