...
import com.licenta.service.DepartmentService;
...
/**
 * REST controller for managing {@link com.licenta.domain.Department}.
 */
@RestController
@RequestMapping("/api")
public class DepartmentResource {
    ...
    @PostMapping("/departments/company/{id}")
    public ResponseEntity<DepartmentDTO> createDepartment(
        ...
        DepartmentDTO result = departmentService.saveDepartmentAndAddCompany(departmentDTO, id);
        return ResponseEntity
            .created(new URI("/api/departments/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, false, ENTITY_NAME, result.getId().toString()))
            .body(result);
