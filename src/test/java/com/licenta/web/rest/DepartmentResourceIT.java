...
class DepartmentResourceIT {
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).code(UPDATED_CODE).email(UPDATED_EMAIL).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.code(UPDATED_CODE).description(UPDATED_DESCRIPTION);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).code(UPDATED_CODE).email(UPDATED_EMAIL).description(UPDATED_DESCRIPTION);
