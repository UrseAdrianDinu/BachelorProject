...
class RoleResourceIT {
    ...
    private static final RoleSeniority DEFAULT_SENIORITY = RoleSeniority.TRAINEE;
    private static final RoleSeniority UPDATED_SENIORITY = RoleSeniority.JUNIOR;
    ...
    public static Role createEntity(EntityManager em) {
        Role role = new Role().name(DEFAULT_NAME).code(DEFAULT_CODE).seniority(DEFAULT_SENIORITY);
        return role;
    }
    ...
    public static Role createUpdatedEntity(EntityManager em) {
        Role role = new Role().name(UPDATED_NAME).code(UPDATED_CODE).seniority(UPDATED_SENIORITY);
        return role;
    }
    ...
    void createRole() throws Exception {
        ...
        assertThat(testRole.getSeniority()).isEqualTo(DEFAULT_SENIORITY);
    }
    ...
    void putExistingRole() throws Exception {
        ...
        updatedRole.name(UPDATED_NAME).code(UPDATED_CODE).seniority(UPDATED_SENIORITY);
        ...
        assertThat(testRole.getSeniority()).isEqualTo(UPDATED_SENIORITY);
    }
    ...
    void fullUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.name(UPDATED_NAME).code(UPDATED_CODE).seniority(UPDATED_SENIORITY);
