...
class TeamResourceIT {
    ...
    public static Team createEntity(EntityManager em) {
        Team team = new Team().name(DEFAULT_NAME).email(DEFAULT_EMAIL);
        return team;
    }
    ...
    public static Team createUpdatedEntity(EntityManager em) {
        Team team = new Team().name(UPDATED_NAME).email(UPDATED_EMAIL);
        return team;
    }
    ...
    void createTeam() throws Exception {
        ...
        assertThat(testTeam.getEmail()).isEqualTo(DEFAULT_EMAIL);
    }
    ...
    void putExistingTeam() throws Exception {
        ...
        updatedTeam.name(UPDATED_NAME).email(UPDATED_EMAIL);
        ...
        assertThat(testTeam.getEmail()).isEqualTo(UPDATED_EMAIL);
    }
    ...
    void fullUpdateTeamWithPatch() throws Exception {
        ...
        partialUpdatedTeam.name(UPDATED_NAME).email(UPDATED_EMAIL);
